        ...
        <>
            ...
            <div style={{ position: "relative", background: "#08080a", overflowX: "clip" }}>
                ...
                <main>
                    ...
                    <section style={{ position: "relative", zIndex: 2, padding: "clamp(44px,7vh,86px) clamp(14px,3.5vw,44px) clamp(36px,6vh,72px)" }}>
                        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
                            <p data-reveal style={{ margin: "0 0 clamp(14px,2.2vh,24px)", fontSize: 10, letterSpacing: ".3em", textTransform: "uppercase", opacity: .5 }}>01 — Archive</p>
                            {/* <blockquote style={{
                                margin: 0,
                                maxWidth: "52ch",
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: "clamp(18px,3vw,48px)", marginTop: 0, paddingTop: "clamp(20px,3vh,30px)", borderTop: "1px solid rgba(237,234,229,.14)" }}>
                                <div data-reveal>
